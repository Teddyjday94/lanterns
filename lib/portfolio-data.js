...
export const projects = [
  ...
  },
  {
    ...
    category: "Websites",
    status: "Published",
    description: "A colorful Gonzales café site built around drinks, pastries, full menus, and easy online ordering.",
    tags: ["Local business", "Menu design", "Responsive UI"],
  ...
  },
  {
    ...
    category: "Websites",
    status: "Published",
    description: "A warm holiday-visit site built around real event photography, appearance options, and community moments.",
    tags: ["Local business", "Event booking", "Photo gallery"],
